...
def run_class(case_name, report_freq, simulation_num):
    ...
    bounds = [[0, 0.001524],[8.608,12.912], [18, 22], [4.4, 6.6], [0.624, 0.936], 
              [0.0025, 0.015], [0.9, 1.1], [0.9, 1.1], [0.1, 0.5]]
...
simulation_num = n_sim  # Set the number of running simulations
